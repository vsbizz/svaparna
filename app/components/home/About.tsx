      ...
      >
        ...
        <div className="mt-20 border-t border-b border-primary-brand/10 py-6 bg-primary-brand/[0.02] relative overflow-hidden">
          <div className="flex select-none">
            {/* Two identical tracks — when first scrolls fully off-screen, second is already in place */}
            {[0, 1].map((track) => (
              <div
                key={track}
                className="flex shrink-0 space-x-16 pr-16 animate-marquee whitespace-nowrap"
              >
              ...
              <div className="pt-4 border-t border-primary-brand/10 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                  {[
                    ...
                    "Vestibular Rehabilitation Certification (Cert VRS)",
                    "Pediatric Bowel and Bladder Certification (Herman & Wallace)",
                    "Ayurvedic Health Counselor Certification (USA)",
                    "Pulse Diagnosis Certification (Nadi Pariksha)",
                    "Molecular and Cellular Biology Alumna (University of Illinois at Urbana-Champaign)",
                  ].map((cert, index) => (
                    <div
                      key={index}
